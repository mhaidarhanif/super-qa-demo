// Generated on 2016-10-12 using generator-angular-fullstack 3.3.0
'use strict';
...
gulp.task('serve', cb => {
	runSequence(['clean:tmp', 'constant'], ['lint:scripts', 'inject'], ['wiredep:client'], ['transpile:client', 'styles'], ['start:server', 'start:client'],
		'watch',
		cb);
});
...
gulp.task('test:client', ['wiredep:test', 'constant'], (done) => {
	...
	//   singleRun: true
	// }, done).start();
	console.log('test:client skipped')
});
